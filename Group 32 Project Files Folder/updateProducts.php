...
<body>
    ...
    <div class="wrapper hovercollapse">
        ...
        <form action="updateProductsScript.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" placeholder="Enter discount here" name="prod_discount" required>
            <br>

            <label for="prod_audit">Audit</label>
            <input type="text" name="prod_audit" value="<?php echo $user_check; ?>" readonly>
            <br>
